...
if (currentContent === nextContent) {
  process.stdout.write(`sync:function-version: already up to date (${normalizedVersion})\n`);
} else {
  writeFileSync(targetPath, nextContent);
  process.stdout.write(`sync:function-version: wrote version ${normalizedVersion} to ${targetPath}\n`);
}
